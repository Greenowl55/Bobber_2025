...
private LEDPattern green = LEDPattern.solid(Color.kGreen).atBrightness(Percent.of(50));
private LEDPattern red = LEDPattern.solid(Color.kRed).atBrightness(Percent.of(50));
private LEDPattern clear = LEDPattern.solid(Color.kWhite).atBrightness(Percent.of(50));
